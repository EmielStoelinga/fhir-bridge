...
import org.ehrbase.fhirbridge.camel.processor.FindObservationOpenEHRProcessor;
...
/**
 * {@link RouteBuilder} implementation that configures the routes for FHIR
 * resources.
 *
 * @since 1.2.0
 */
...
public class ResourceRouteBuilder extends AbstractRouteBuilder {
        ...
        /**
         * Configures available endpoints for {@link org.hl7.fhir.r4.model.AuditEvent
         * AuditEvent} resource.
         */
        ...
        /**
         * Configures available endpoints for {@link org.hl7.fhir.r4.model.Condition
         * Condition} resource.
         */
        ...
        /**
         * Configures available endpoints for {@link org.hl7.fhir.r4.model.Consent
         * Consent} resource.
         */
        ...
        /**
         * Configures available endpoints for
         * {@link org.hl7.fhir.r4.model.DiagnosticReport DiagnosticReport} resource.
         */
        ...
        /**
         * Configures available endpoints for {@link org.hl7.fhir.r4.model.Encounter
         * Encounter} resource.
         */
        ...
        /**
         * Configures available endpoints for {@link org.hl7.fhir.r4.model.Immunization
        ...
        /**
         * Configures available endpoints for
         * {@link org.hl7.fhir.r4.model.MedicationStatement MedicationStatement}
         * resource.
         */
        ...
        /**
         * Configures available endpoints for {@link org.hl7.fhir.r4.model.Observation
        ...
        private void configureObservation() {
                ...
                from("observation-find:observationEndpoint?fhirContext=#fhirContext")
                        .choice()
                                .when(exchange -> properties.isDatabaseSearch())
                                        .process(ResourcePersistenceProcessor.BEAN_ID)
                                .when(exchange -> !properties.isDatabaseSearch())
                                        .process(FindObservationOpenEHRProcessor.BEAN_ID)
                                .otherwise()
                                        .throwException(new NotImplementedOperationException(
                                                "Configuration search-mode should be 'openehr' or 'database'"));
        }

        /**
         * Configures available endpoints for {@link org.hl7.fhir.r4.model.Patient
         * Patient} resource.
         */
        ...
        /**
         * Configures available endpoints for {@link org.hl7.fhir.r4.model.Procedure
         * Procedure} resource.
         */
        ...
        /**
         * Configures available endpoints for
         * {@link org.hl7.fhir.r4.model.QuestionnaireResponse QuestionnaireResponse}
         * resource.
         */
        ...
        /**
         * Configures available endpoints for {@link org.hl7.fhir.r4.model.Composition}
         * resource.
         */
